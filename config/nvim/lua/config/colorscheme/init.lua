...
function M.setup(colors, config)
	...
	hi.DiagnosticError = { guifg = M.colors.base0E, guibg = nil, gui = "none", guisp = nil }
	hi.DiagnosticWarn = { guifg = M.colors.base0B, guibg = nil, gui = "none", guisp = nil }
	hi.DiagnosticInfo = { guifg = M.colors.base0A, guibg = nil, gui = "none", guisp = nil }
	hi.DiagnosticHint = { guifg = M.colors.base05, guibg = nil, gui = "none", guisp = nil }
	hi.DiagnosticUnderlineError = { guifg = nil, guibg = nil, gui = "undercurl", guisp = M.colors.base08 }
	hi.DiagnosticUnderlineWarning = { guifg = nil, guibg = nil, gui = "underline", guisp = M.colors.base0E }
	hi.DiagnosticUnderlineWarn = { guifg = nil, guibg = nil, gui = "underline", guisp = M.colors.base0E }
	hi.DiagnosticUnderlineInformation = { guifg = nil, guibg = nil, gui = "underline", guisp = M.colors.base0F }
	hi.DiagnosticUnderlineHint = { guifg = nil, guibg = nil, gui = "underline", guisp = M.colors.base0C }
	...
	hi.TSKeyword = { guifg = M.colors.base0E, guibg = nil, gui = "bold,italic", guisp = nil }
	hi.TSKeywordFunction = { guifg = M.colors.base0A, guibg = nil, gui = "italic", guisp = nil }
	...
	hi.TSParameter = { guifg = M.colors.base0C, guibg = nil, gui = "italic", guisp = nil }
	...
	hi.TSPunctSpecial = { guifg = M.colors.base0E, guibg = nil, gui = "none", guisp = nil }
	...
	hi.TSTag = { guifg = M.colors.base0E, guibg = nil, gui = "none", guisp = nil }
	hi.TSTagDelimiter = { guifg = M.colors.base0F, guibg = nil, gui = "none", guisp = nil }
	hi.TSTagAttribute = { guifg = M.colors.base0A, guibg = nil, gui = "italic", guisp = nil }
	...
	hi.TSVariableBuiltin = { guifg = M.colors.base0A, guibg = nil, gui = "italic", guisp = nil }
	...
	hi.typescriptGlobal = { guifg = M.colors.base0A, guibg = nil, gui = "italic", guisp = nil }

	if M.config.ts_rainbow then
		hi.rainbowcol1 = { guifg = M.colors.base06 }
		hi.rainbowcol2 = { guifg = M.colors.base0E }
		hi.rainbowcol3 = { guifg = M.colors.base0A }
		hi.rainbowcol4 = { guifg = M.colors.base06 }
		hi.rainbowcol5 = { guifg = M.colors.base0C }
		hi.rainbowcol6 = { guifg = M.colors.base0E }
		hi.rainbowcol7 = { guifg = M.colors.base06 }
	end
	...
	vim.g.terminal_color_1 = darken(M.colors.base0E, 0.2)
	vim.g.terminal_color_2 = darken(M.colors.base0D, 0.2)
	vim.g.terminal_color_3 = M.colors.base0C
	vim.g.terminal_color_4 = darken(M.colors.base0A, 0.2)
	vim.g.terminal_color_5 = darken(M.colors.base09, 0.2)
	vim.g.terminal_color_6 = darken(M.colors.base0A, 0.1)
	vim.g.terminal_color_7 = M.colors.base03
	vim.g.terminal_color_8 = M.colors.base01
	vim.g.terminal_color_9 = M.colors.base0E
	vim.g.terminal_color_10 = M.colors.base0D
	vim.g.terminal_color_11 = M.colors.base0B
	vim.g.terminal_color_12 = M.colors.base0A
	vim.g.terminal_color_13 = M.colors.base09
	vim.g.terminal_color_14 = M.colors.base08
	vim.g.terminal_color_15 = M.colors.base05
end
