...
myFont :: String
myFont = "xft:Codelia Ligatures:medium:size=12:antialias=true:hinting=true"
...
myShowWNameTheme = def
    { swn_font              = "xft:Codelia Ligatures:bold:size=60"
    , swn_fade              = 1.0
    , swn_bgcolor           = "#1c1f24"
    , swn_color             = "#ffffff"
    }
...
myWorkspaces = def { workspaces = withScreens 2 [" dev ", " web ", " sys ", " game ", " design ", " chat ", " x ", " y ", " z "] } 
...
myKeys =
    ...
    -- KB_GROUP Run Prompt
        , ("M-d", spawn "sh ~/.config/rofi/launchers/colorful/launcher.sh") -- Dmenu
